    ...
    **Available attributes:**
    ...
    def _setup_parallelism_config(
        ...
        if parallelism_config is None:
            if PartialState._shared_state != {} and PartialState._shared_state.get("parallelism_config", None) is not None:
                ...
                parallelism_config = PartialState._shared_state.get("parallelism_config", None)
            else:
